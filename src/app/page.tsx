      ...
      <section className="py-16 px-4 bg-white border-t border-gray-100">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-3xl font-bold text-center text-gray-900 mb-4">
            See what ABCflow creates
          </h2>
          <p className="text-center text-gray-500 mb-10 max-w-xl mx-auto">
            Real videos generated by our users with a single text prompt.
          </p>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            {["/sample1.mp4", "/sample2.mp4", "/sample3.mp4"].map((src) => (
              <div key={src} className="relative w-full aspect-video rounded-2xl overflow-hidden shadow-md bg-gray-900">
                <video
                  src={src}
                  autoPlay
                  loop
